...
<head>
<meta charset="euc-kr">
<link href="assets/css/common4.css" rel="stylesheet" type="text/css" media="all">
...
<?
	...
	{
?>
		<form  name="board_form" method="post" action="insert_board.php?mode=modify&num=<?=$num?>&page=<?=$page?>&table=<?=$table?>" enctype="multipart/form-data">
<?
	}
	else
	{
?>
		<form  name="board_form" method="post" action="insert_board.php?table=<?=$table?>" enctype="multipart/form-data">
<?
	}
?>
		<div id="write_form">
...
?>
		...
		<div id="write_button"><a href="#"><img src="assets/img/ok.png" onclick="check_input()"></a>&nbsp;
